...
def select_series_title_with_most_human_characters
  ...
  "SELECT series.title FROM series INNER JOIN characters ON series.id = characters.series_id WHERE characters.species = 'human' ORDER BY series.title;"
  ...
  # "SELECT characters.species, COUNT(characters.species) FROM characters GROUP BY characters.species ORDER BY characters.species DESC"
  # "SELECT series.title FROM series INNER JOIN characters ON series.id = characters.series_id GROUP BY characters.species ORDER BY characters.species"
  # "SELECT series.title FROM series INNER JOIN characters ON series.id = characters.series_id GROUP BY characters.species HAVING COUNT(characters.species)"
end
#  COUNT(characters.species) as species_count GROUP BY characters.species ORDER BY characters.species DESC LIMIT 1
